...
class GetProposalModel {
  ...
  @override
  String toString() {
    return 'GetProposalModel(proposalId: $proposalId, demandlistId: $demandlistId, proposalState: $proposalState, supplierCompany: $supplierCompany, productProposals: $productProposals)';
  }
